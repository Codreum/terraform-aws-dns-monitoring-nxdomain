...
| Supported subnet\_count | 1, 2, or 4 only | 1 to 64 (power-of-2 options) |
...
* [**aws\_region**](#input_aws_region)

  * Description: Region for free VPC deployment
  * Type: `string`
  * Default: n/a
  * Required: yes
* [**enable\_resolver\_query\_logging**](#input_enable_resolver_query_logging)
...
* [**prefix**](#input_prefix)
  ...
  * Default: n/a
  * Required: yes
* [**resolver\_query\_log\_config\_name**](#input_resolver_query_log_config_name)

  * Description: Optional name for the Route 53 Resolver query log config.
  * Type: `string`
  * Default: `null`
  * Required: no
* [**resolver\_query\_log\_destination\_arn**](#input_resolver_query_log_destination_arn)
...
* [**resolver\_query\_log\_config\_arn**](#output_resolver_query_log_config_arn) — n/a
