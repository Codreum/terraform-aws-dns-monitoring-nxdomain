...
This project is an infrastructure/IaC module. Discussions may include production risks, security concerns, and operational constraints. We commit to communicating with empathy, clarity, and respect—especially when reviewing code that could impact reliability or safety.
...
Maintainers have the right and responsibility to remove, edit, or reject comments, commits, code, wiki edits, issues, and other contributions that are not aligned with this Code of Conduct. Maintainers may temporarily or permanently ban any contributor for behaviors they consider inappropriate, threatening, offensive, or harmful.
...
To report a Code of Conduct issue, contact: **[support@codreum.com](mailto:support@codreum.com)**.  
